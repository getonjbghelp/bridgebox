...
Пять разделов, идут по частоте обращения - **Сеть** и **Профили** первыми
(это то, что реально крутят, когда игра не подключается), дальше **Общие**,
**Обновления** и **Система**. Разобраны [ниже](#все-настройки-по-пунктам).
